...
import { useAddUniversityGraduateGraduationDetail, useGetUniversityGraduateGraduationDetail } from "@/hooks/api/university/university.query";
...
export default function GraduationForm() {
  ...
  const { mutate: addUniversityGraduateGraduationDetail, isPending: isSaving } = useAddUniversityGraduateGraduationDetail();
  const { data: graduationResponse, isLoading: isLoadingGraduation, error: graduationError } = useGetUniversityGraduateGraduationDetail();
  ...
  const handleSaveAsDraft = () => {
    ...
    addUniversityGraduateGraduationDetail(payload);
    setIsFormSubmitted(true);
    setIsReadOnly(true);
  };
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    placeholder="e.g., 6-year graduation rate for cohort"
                    className="flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-[#111418] focus-visible:ring-0 focus-visible:ring-offset-0 border-none bg-[#f0f2f5] h-14 placeholder:text-[#60748a] p-4 text-base font-normal leading-normal"
