...
import { useAnswerQuestion } from '@/hooks/api/jobs/jobs.query';
...
export const JobApplicationForm = ({ job }: JobApplicationFormProps) => {
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-yellow-700">Please log in to submit your application for this job.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="bg-red-50 border border-red-200 rounded-lg p-6 mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-red-700">Only students can submit applications for jobs.</p>
            </div>
          </div>
        </div>
      </div>
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const missingFields = job.questions
      ...
      // Format data according to your API schema (same as opportunities)
      const answersData = {
      ...
      answerQuestionMutation.mutate(answersData, {
        onSuccess: () => {
          ...
          // Redirect back to job page after successful submission
          setTimeout(() => {
        ...
        <div className="p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-gray-600">{job.title} at {job.university?.university_name}</p>
            </div>
          </div>
