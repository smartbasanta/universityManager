...
import { useGetJobApplications } from '@/hooks/api/jobs/jobs.query';
import { useGetJobById } from '@/hooks/api/jobs/jobs.query';
...
export default function JobApplicationsPage() {
  ...
  const { data: applicationsData, isLoading, error } = useGetJobApplications({
    jobId,
    page: currentPage,
    limit: 50
  });
        ...
        <div className="gap-1 px-6 flex flex-1 justify-center py-5">
          <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
            ...
            <div className="flex flex-col items-center text-center mb-6">
              <p className="text-[#111418] text-lg font-semibold">{job?.title || 'Job Applications'}</p>
